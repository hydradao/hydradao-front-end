...
const lightTheme = {
  ...
  background: "linear-gradient(180.37deg, #880ED4 0.49%, #2D74A7 26.3%, #7EC8E3 99.85%)",
  paperBg: "linear-gradient(65.7deg, #F5F5F5 8.35%, #d9ead3 100%)",
  modalBg: "#FAFAFAEF",
  ...
  primaryButtonBG: "#6EB3C6",
  primaryButtonHoverBG: "#4190a6",
  // these need fixing
